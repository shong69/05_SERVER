...
<body>
	...
	<ul>
		...
		<li> \${paramValues.name속성값[인덱스]} : name이 일치하는 파라미터 중 지정된 인덱스번째 value가져옴 </li>
	</ul>
	...
	<p>
		...
		opt : ${param.opt} <br> <!-- 맨 처음 인덱스만 반환된다 -->
	...
	<hr>
	<h1>El은 null과 비어있다를 같은 걸로 인식한다</h1>
	
	${list1}   /   ${list2}
	
	<h4>empty 연산자를 사용해서 확인해보기</h4>
